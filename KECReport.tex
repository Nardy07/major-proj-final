...
\makebox[9cm]{Aman Devkota  \hfill[41407]}\\
\makebox[9cm]{Ankur Karmacharya  \hfill[41410]}\\
\makebox[9cm]{Prashad Adhikary  \hfill[41451]}
...
\newcommand{\defDay}{6} %specify Defense Day- 1, 2, ...
...
\newcommand{\external}{Er. Ajaya Shrestha} %Specify Name of External for Major Project (Required for Black Book)
\newcommand{\degExternal}{Senior Assistant Professor\\Advanced College of Engineering and Management} %Specify Name of External for Major Project (Required for Black Book) , use multiple lines (\\) if necessary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
	%\includegraphics[width = 3in]{images/logo.png}
	\includegraphics[width=4in]{images/wm123.png} 
...
\begin{figure}[H] % tbh means top, bottom or here (priority: left to right)
	\begin{center}
		%\includegraphics[width = 3in]{images/logo.png}
		\includegraphics[width=6in]{images/incremmodel.jpg} 
...
\begin{figure}[tbh]
	\begin{center}
		...
		\caption{Loss plot of Attack labels for train and test dataset} %figure name
		\label{Loss plot of Attack labels for train and test dataset} % for referencing
	\end{center}
\end{figure}
...
\begin{figure}[H] % tbh means top, bottom or here (priority: left to right)
	\begin{center}
		...
		\caption{Confusion Matrix of Attack labels for Test dataset} %figure name
...
\begin{figure}[tbh]
	\begin{center}
		\includegraphics[width=4in]{images/attacvnormlab.png}
	\end{center}
\end{figure}
\begin{figure}[H]
	\begin{center}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=4in]{images/attlabxx.png}
	\end{center}
\end{figure}
\begin{figure}[H]
	\begin{center}
...
\begin{figure}[tbh]
	\begin{center}
		\includegraphics[width=6in]{images/annex.png}
	\end{center}
\end{figure}
%\chapter*{brother}
