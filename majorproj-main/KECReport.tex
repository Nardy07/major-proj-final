...
\makebox[7cm]{Aman Devkota  \hfill[41407]}\\
\makebox[7cm]{Ankur Karmacharya  \hfill[41410]}\\
\makebox[7cm]{Prashad Adhikary  \hfill[41451]}
...
\newcommand{\external}{} %Specify Name of External for Major Project (Required for Black Book)
\newcommand{\degExternal}{} %Specify Name of External for Major Project (Required for Black Book) , use multiple lines (\\) if necessary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
